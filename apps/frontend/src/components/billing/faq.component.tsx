  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by Forgeit?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'This is a beta release, no.'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        `Can I trust ${isGeneral ? 'Postiz' : 'Forgeit'}?`
      ),
      description: t(
        'faq_postiz_gitroom_is_proudly_open_source',
        `${
          isGeneral ? 'Postiz' : 'Forgeit'
        } is proudly open-source! We believe in an ethical and transparent culture, meaning that ${
          isGeneral ? 'Postiz' : 'Forgeit'
        } will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/forge-it/postiz-app" target="_blank" style="text-decoration: underline;">click here</a>.`
      ),
    },
    {
