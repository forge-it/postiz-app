        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            ...
            <p>
              ...
              social networks, including Facebook, Instagram, Twitter, LinkedIn,
              and TikTok (collectively, the "Social Networks") are governed by
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                provide this). We may also obtain this information if you use a
                social login service like Facebook Login to create or access
                your account.
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                If you share this information, please provide a specific
                location, such as an address, a city, or a place (for example, a
                restaurant).
              </li>
              <li>
              ...
              <li>
                Social media content and other user-generated content (for
                example, posts, comments, pages, profiles, likes, and feeds)
              </li>
              <li>
              ...
              <li>
                Social media and messaging metadata (for example, number of
                social media followers, number of posts, number of tweets)
              </li>
              <li>
                Content that you may send and receive through Social Networks
                and other messaging services, such as SMS, may contain personal
                information of third parties. This may include information such
                as names, photos, age, gender, geographic location, opinions,
                preferences, and phone numbers that are provided or posted by
                social media users.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Usage data and analytics may include the frequency of logins and
                the different types of activity users undertake, such as
                frequently accessed service areas.
              </li>
              <li>
                General Location information, such as IP address and the region
                in which you are located when logging in and using the Services,
                by the settings on your device.
              </li>
              <li>
            ...
            <p>
              Surveys, contests, and events (such as webinars and in-person
              events) for those we host or are affiliated with:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
              ...
              <li>
                ...
                includes annual company revenue, number of employees, and
                industry. We may also use service providers to obtain additional
                business-related information about your organization, such as
                the legal name, size, and publicly available revenue, to assist
                us in offering services appropriate to your organization's
                needs.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                Social media: Your messages, posts, and other interactions with
                our brand and social media accounts.
              </li>
              <li>
                Email interactions and analytics: Information on how you engage
                with our emails, such as email open and click rates, whether a
                link is clicked, which web pages are visited after opening the
                email, the type of browser and email clients you use, and
                general location (i.e., country and region) information.
              </li>
              <li>
                Teleconference, videoconference, and other meetings: Your
                preferences, feedback, opinions, and business needs; and
                recordings of these sessions if you agree.
              </li>
              <li>
                Accessing resources (e.g. videos, whitepapers or case studies)
                on our website: Your name and contact information, and
                engagement analytics such as the type and frequency of resources
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                inquiry, provide feedback, or make another request, we may
                collect information about you such as your name and email
                address, your specific feedback or request, and information
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Where you have chosen to share your specific location
                information, we use this information to provide location based
                features, such as enabling you to share your location on your
                posts for Social Networks that support this functionality, and
                to use any functionality that relies on location information.
              </li>
              <li>
                We analyze your information, including usage information, social
                media metadata, your feedback, support queries, and survey
                responses to identify issues and help us understand how you use
                the Services so that we can make improvements to our Services
                and to provide aggregated user analytics, insights and
                measurement reports.
              </li>
              <li>
                We use Content, information that you send and receive through
                Social Networks, and other information from these Social
                Networks (such as your messages, posts, comments, images,
                advertising, and other material you curate on and upload to the
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                effectiveness of, and to make improvements to our
                communications. We also use engagement analytics to better
                understand your needs so that we can provide the information and
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                We use information about you to help us understand usage
                patterns and other activities on our websites and applications
                so that we can diagnose problems and make improvements,
                including enhancing usability and security. We also use website
                personalization software to help us present information on our
                websites that may be more relevant to you, such as displaying
              ...
              <li>
                ...
                and other interactions to our customer support and sales teams,
                we may use, monitor, and record this information for training
                purposes, to make improvements to our internal sales and
            ...
            <p>
              ...
              can be made in writing to our privacy team and will be handled
              within thirty (30) days unless they are unusually extensive or
              complex, in which case we will advise you of the expected timeline
            ...
            <p>
              ...
              normal procedure for deleting stored data, you may revoke our
            ...
            <p>
              Our authorized contractors may need to access information about
              you when they require this information to perform their job. For
              example, a customer support representative would need access to
              your account to validate your identity and respond to your
              question or request; our email communications team would need
              access to your contact information to ensure this information is
              sent correctly and any unsubscribe requests are properly managed;
              and our security staff would need to review information to
              investigate attempted denial of service attacks, fraudulent
            ...
            <p>
              ...
              Services, this connection uses YouTube's API services, and the{' '}
              <a
            ...
            <p>
              ...
              protection laws, information about you may only be transferred
              from your region to other regions if certain requirements are met.
              For instance, under the GDPR, information about you may be
              transferred from the European Economic Area (EEA) to outside the
            ...
            <p>
              By its nature, social media data can be shared with people around
              the globe. The Social Networks and Third-Party Services that you
              choose to integrate with our Services may collect, store, and
            ...
            <p>
              ...
              session. We store other Content that you produce (such as draft
              Content for publication on Social Networks) so that you can easily
              access this material on the Services.
            </p>
            <p>
              Aggregated data is used by Postiz for analysis, product
              improvement, and troubleshooting purposes. In some cases, Content
              may continue to exist on the Social Networks even after you or we
              delete it from our Services, and you will need to contact the
              relevant Social Network directly if you want it to remove this
              Content.
            </p>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Your consent</strong> (for example, when you have
                provided your information to sign up for an account or a
                webinar, or you have provided your employment history when
                applying for a job). Where we rely on your consent to process
                personal data, you can withdraw your consent at any time.
              </li>
              <li>
                <strong>It is necessary to perform a contract</strong> (for
                example, we may need your information to fulfill our obligations
                to provide you with Services under the terms relevant to the
                Services you have acquired).
              </li>
              <li>
                <strong>Legitimate interest</strong> (for example, to provide,
                maintain and improve the Services for you, to maintain the
                security of the Services, and to attract new customers to
                maintain demand for the Services.
              </li>
              <li>
                <strong>Legal obligation</strong> In some cases, we may have a
                legal obligation to process your personal data to comply with
                relevant laws (for example, processing payroll and tax
                information to comply with relevant employment and tax
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                that we restrict the processing of information about you (for
                example, where you believe that this information is inaccurate).
              </li>
              <li>
            ...
            <p>
              ...
              process Content to improve further the Services, such as enhancing
            ...
            <p>
              ...
              deletion, sharing, and retention of personal data and Content,
            ...
            <p>
              ...
              Privacy Act (CCPA) and as amended by the California Privacy Rights
              Act (CPRA) (collectively, "California Privacy Laws'). In that
            ...
            <p>
              We have outlined certain rights in the section "What are your
              privacy rights?"
            </p>
            <p>
              Under the California Privacy Laws, you may have the following
              specific rights:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                The right to know about the personal information collected about
                you, which we have set out under "What information do we
                collect?"
              </li>
            ...
            <p>
              You may access, update, or correct most of your Account
            ...
            <p>
              While we disclose personal information to service providers for
              the purpose of managing our relationship with you (e.g.
            ...
            <p>
              ...
              use personal information about you. For more detailed information
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Marketing cookies:</strong> These may be set through our
            ...
            <p>
              Some third-party services may also be integrated directly into our
            ...
            <p>
              ...
              do not knowingly collect, use, or disclose personal information
            ...
            <p>
              ...
              relevant supervisory authority and affected individuals in
              accordance with applicable data protection laws. We will provide
              information about the nature of the breach, the categories and
              approximate number of data subjects concerned, the likely
            ...
            <p>
              We may change this privacy policy at any time to reflect updates
              to our Services, applicable laws, and other factors. If we make
              any material changes, we will include a prominent notice on this
              website and/or our Services, but we encourage you to review this
              policy periodically to stay informed.
            </p>
            <p>
              When we update our Privacy Policy, we will update the "Last
              Updated" date at the top of this policy. Your continued use of our
