      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p className="text-sm text-gray-500 mb-6"><strong>Last Updated:</strong> December 2024</p>
            
            <p>At Postiz ("Company," "we," "us," or "our"), we are committed to protecting the privacy and security of our users' personal information. This Privacy Policy outlines how we collect, use, and safeguard the personal information collected on our website. By accessing or using our website, registering for the Website, and providing your personal information, you agree to the terms and conditions of this Privacy Policy.</p>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">1. Our Services</h2>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Postiz Services</h3>
            <p>Postiz's suite of social media management and social care tools is accessible via our websites and mobile applications. These tools allow you to combine all your social media accounts for easy access and management through a single online platform. Through this platform, you can manage your social media, marketing, and advertising campaigns, engage with your audiences, schedule and publish messages, manage customer care communications, and analyze the results of these activities.</p>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Social Networks</h3>
            <p>Any collection, use, and management of personal information by the social networks, including Facebook, Instagram, Twitter, LinkedIn, and TikTok (collectively, the "Social Networks") are governed by their respective privacy policies and terms. When using Social Networks, you must comply with their privacy policies and terms. We recommend carefully reviewing their privacy policies and terms, as Postiz is not responsible for Social Networks.</p>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Your Privacy Obligations</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Business Purposes</h3>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">2. What information do we collect?</h2>
            <p>We collect information about you as reasonably necessary for the following activities:</p>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Using our Services</h3>
            <p>We may collect the following information when you use our Services:</p>

            <h4 className="text-lg font-semibold text-gray-900 mt-4 mb-2">Account information:</h4>
            ...
            <h4 className="text-lg font-semibold text-gray-900 mt-4 mb-2">Content:</h4>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h4 className="text-lg font-semibold text-gray-900 mt-4 mb-2">Logs, usage, and support data:</h4>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Surveys, events, marketing, and other activities</h3>
            ...
            <h4 className="text-lg font-semibold text-gray-900 mt-4 mb-2">Other interactions:</h4>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Browsing our websites</h3>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Postiz and our authorized service providers use cookies and similar tracking technologies, including web beacons, pixels, and software tokens, on our websites and services.</li>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">3. How do we use your information?</h2>
            <p>We use your information for the purposes described below:</p>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Providing and securing our Services</h3>
            <ul className="list-disc pl-6 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Communicating with you</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li>We use your contact information where appropriate to send you information about our Services, events, marketing communications (consistent with your preferences).</li>
              <li>We use email statistics, such as open rates, to assess the effectiveness of, and to make improvements to our communications. We also use engagement analytics to better understand your needs so that we can provide the information and services that would be more suitable for you.</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Improving our websites and applications</h3>
            <ul className="list-disc pl-6 space-y-2">
              <li>We use information about you to help us understand usage patterns and other activities on our websites and applications so that we can diagnose problems and make improvements, including enhancing usability and security. We also use website personalization software to help us present information on our websites that may be more relevant to you, such as displaying resources applicable to your industry or organization size.</li>
              <li>If you choose to provide information about you, your usage of social media services and other feedback during telephone calls and other interactions to our customer support and sales teams, we may use, monitor, and record this information for training purposes, to make improvements to our internal sales and marketing processes, and to improve our Services.</li>
            </ul>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">4. What are your rights regarding the information about you?</h2>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Services information</h3>
            ...
            <p>If you have requests that cannot be carried out by logging in to your account, such as accessing additional information or deleting information about you, for the Postiz services, please email our privacy team at <a href="mailto:privacy@postiz.com" className="text-blue-600 hover:underline">privacy@postiz.com</a>. Please note that we may need to retain certain information about you for as long as you maintain an account for our Services, to provide you with our Services, for record keeping purposes, for payment processing, to comply with our legal and regulatory obligations, to resolve disputes, or to enforce the Postiz terms of service, or other agreement in place between you (or your organization) and Postiz (collectively, the "Terms of Service").</p>
            ...
            <p>If you have authorized us to access your Social Network account to provide the Services, you may revoke this access at any time by emailing our support team at <a href="mailto:support@postiz.com" className="text-blue-600 hover:underline">support@postiz.com</a>. For example, if you have authorized us to access your information via the YouTube API services, in addition to our normal procedure for deleting stored data, you may revoke our access to your data via the Google security settings page.</p>
            <p>You can contact our Support team for other general requests at <a href="mailto:support@postiz.com" className="text-blue-600 hover:underline">support@postiz.com</a>.</p>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Marketing emails, advertising and website browsing</h3>
            <p>For marketing communications, you may opt out of marketing communications sent by Postiz by clicking on the unsubscribe link in the marketing email you receive. Please note that if you are a Postiz user, unsubscribing from marketing communications will not affect product-generated emails sent in connection with your use of our Services.</p>
            <p>Postiz participates in interest-based advertising (where you may have visited our websites or another website which allows us to display advertising relating to our Services). The Network Advertising Initiative has developed a tool that may help you understand which third parties have currently enabled cookies for your browser and how to opt out of those cookies. For more information and to opt out of interest-based advertising, you can visit the <a href="https://optout.networkadvertising.org/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Network Advertising Initiative opt-out page</a>.</p>
            <p>For more information on how to opt out of marketing cookies, review our Cookie Notice.</p>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">5. Who has access to your information?</h2>
            <p>Postiz does not rent or sell your information. We restrict access to your information to authorized employees and we do not share your information with third parties except in the circumstances explained below.</p>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Authorized Contractors</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Service Providers, Authorized Resellers, and Partners</h3>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Social Networks and Third-Party Services</h3>
            <p>Where you are using our Services and have chosen to connect your Social Networks to the Services, or if you authorize a Third-Party Service to access your account, you are agreeing to provide information about you to the Social Networks and the Third-Party Services under their respective terms and privacy policies. For example, if you choose to connect your YouTube account to the Services, this connection uses YouTube's API services, and the <a href="https://policies.google.com/privacy" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Google Privacy Policy</a> will apply to you.</p>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Customer Organizations</h3>
            <p>Where your employer or an entity has purchased Services on your behalf, we may disclose information about you such as your name and email address, and some usage information including whether a user has logged in to the Service, frequency of login, time spent using the Services, and enrollment and completion of Postiz Academy courses to assist your employer or the entity in managing its use and maximizing the value of the Services.</p>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Successor and Affiliated Entities</h3>
            <p>We may share information about you among Postiz-controlled affiliates and subsidiaries, and they will protect your information in a manner that is consistent with this Privacy Policy and where applicable, in accordance with the privacy policy specific to the entity.</p>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Law Enforcement, Government Agencies, and Professional Advisors</h3>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">6. What international data transfers occur at Postiz?</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">7. How do we safeguard your information?</h2>
            <p>Postiz maintains industry standard security safeguards to protect your information. This includes ensuring our employees receive appropriate security and privacy training and guidance so they are aware of the measures they need to implement to protect your information.</p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">9. Postiz's roles under the GDPR and UK data protection laws</h2>
            <p>Depending on the situation and the type of data involved, Postiz may act as a data controller or a data processor.</p>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Postiz as a data controller</h3>
            <p>Postiz may act as a data controller when we are:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Collecting information from you to set up and administer your Postiz account (for example, Account information such as your name and email address);</li>
            ...
            <h4 className="text-lg font-semibold text-gray-900 mt-4 mb-2">Legal bases for processing when Postiz is a data controller</h4>
            <p>The legal bases for processing information about you include:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Your consent</strong> (for example, when you have provided your information to sign up for an account or a webinar, or you have provided your employment history when applying for a job). Where we rely on your consent to process personal data, you can withdraw your consent at any time.</li>
              <li><strong>It is necessary to perform a contract</strong> (for example, we may need your information to fulfill our obligations to provide you with Services under the terms relevant to the Services you have acquired).</li>
              <li><strong>Legitimate interest</strong> (for example, to provide, maintain and improve the Services for you, to maintain the security of the Services, and to attract new customers to maintain demand for the Services.</li>
              <li><strong>Legal obligation</strong> In some cases, we may have a legal obligation to process your personal data to comply with relevant laws (for example, processing payroll and tax information to comply with relevant employment and tax legislation); or processing is necessary to protect your vital interests or those of another person (for example, obtaining health-related information during a medical emergency).</li>
            </ul>

            <h4 className="text-lg font-semibold text-gray-900 mt-4 mb-2">Your rights when Postiz is a data controller</h4>
            <p>Where Postiz is acting as a data controller, we have outlined certain rights in the "What are your privacy rights?" section.</p>
            <p>In addition, you may have the following rights:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Right to object to processing:</strong> You may request that Postiz stop processing information about you (for example, stop sending you marketing communications).</li>
              <li><strong>Right to restrict processing:</strong> You may request that we restrict the processing of information about you (for example, where you believe that this information is inaccurate).</li>
              <li><strong>Right to data portability:</strong> You may request that we provide you with information Postiz has about you in a structured, machine-readable, and commonly used format or transfer this information to another data controller.</li>
            </ul>
            <p>If you would like assistance on any of the above requests, please email our Privacy team at <a href="mailto:privacy@postiz.com" className="text-blue-600 hover:underline">privacy@postiz.com</a>.</p>

            <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Postiz as a data processor</h3>
            <p>When you use our Services and make decisions about the personal data being processed in them (including selecting the Social Network accounts you wish to connect to the Services or uploading and using Content), you are acting as a data controller, and Postiz is acting as a data processor.</p>
            <p>As a data controller, you have certain obligations under the GDPR, including managing Content on the Services. As a data processor, Postiz will only access and process Content to provide you with the Services by your instructions (which you provide through the Services), the Terms of Service, the Social Networks' terms, and applicable laws. As part of delivering the Services, we may process Content to improve further the Services, such as enhancing usability and developing new features.</p>
            <p>As a data controller, suppose you require Postiz to agree to data protection requirements under Article 28, GDPR, or UK data protection laws. In that case, Postiz makes available a data processing addendum that meets these requirements.</p>
            <p>If you are using the Services as an authorized user of a Postiz customer (whether that customer is your employer, another organization, or an individual), that customer determines its own policies (if any) regarding storage, access, modification, deletion, sharing, and retention of personal data and Content, which may apply to your use of the Services. Please check with that customer about the policies and settings it has in place.</p>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">10. Your California Privacy Rights</h2>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>The right to know about the personal information collected about you, which we have set out under "What information do we collect?"</li>
            ...
            <p>You may access, update, or correct most of your Account information by logging in to your account; or you may exercise your rights by emailing our Privacy team at <a href="mailto:privacy@postiz.com" className="text-blue-600 hover:underline">privacy@postiz.com</a>.</p>
            ...
            <p>We use cookies and similar tracking technologies to collect and use personal information about you. For more detailed information about the types of cookies we use, why, and how you can control cookies, please see our Cookie Notice.</p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">12. Third-Party Links and Services</h2>
            <p>Our Services may contain links to third-party websites, applications, and services that are not owned or controlled by Postiz. We are not responsible for the privacy practices of these third parties. We encourage you to read the privacy policies of every website and service that you visit or use.</p>
            <p>Some third-party services may also be integrated directly into our Services (such as payment processors, analytics providers, and social media platforms). These integrations are governed by the respective third parties' privacy policies and terms of service.</p>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">13. Children's Privacy</h2>
            ...
            <p>If you believe that we might have collected information from a child under 18, please contact us at <a href="mailto:privacy@postiz.com" className="text-blue-600 hover:underline">privacy@postiz.com</a>.</p>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">14. Data Breach Notification</h2>
            <p>In the event of a data breach that is likely to result in a high risk to the rights and freedoms of individuals, we will notify the relevant supervisory authority and affected individuals in accordance with applicable data protection laws. We will provide information about the nature of the breach, the categories and approximate number of data subjects concerned, the likely consequences, and the measures taken or proposed to address the breach.</p>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">15. Changes to this Privacy Policy</h2>
            ...
            <p>When we update our Privacy Policy, we will update the "Last Updated" date at the top of this policy. Your continued use of our Services after any changes indicates your acceptance of the updated Privacy Policy.</p>
